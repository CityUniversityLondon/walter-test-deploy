...
/* harmony import */ var _wrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../wrapper */ "./src/wrapper.js");
...
try {
  _patterns_finder_matrix_matrix__WEBPACK_IMPORTED_MODULE_1__["default"].launch(_wrapper__WEBPACK_IMPORTED_MODULE_0__["default"]);
} catch (e) {
  print('<!--Error: ' + e + ' -->');
}
...
/* harmony import */ var _renderer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./renderer */ "./src/patterns/finder/matrix/renderer.js");
...
/* harmony default export */ __webpack_exports__["default"] = ((function () {
  var launch = function launch(formData) {
    try {
      var initialResults = JSON.parse(_REST.response && _REST.response.body || {} // eslint-disable-line
      ),
          queryStr = '%globals_server_QUERY_STRING^urldecode^striphtml%',
          vars = queryStr.split('&'),
          params = vars.reduce(function (p, pair) {
      ...
      Object(_renderer__WEBPACK_IMPORTED_MODULE_5__["render"])(formData, config, params, initialResults, function (err, html) {
...
var render = function render(formData, config, initialQuery, initialResults, cb) {
  var Form = formData,
...
function Wrapper(props) {
  var Course = props.initialResults && props.initialResults.results && props.initialResults.results.map(function (e, i) {
    var code = e.listMetadata.code && e.listMetadata.code[0],
        title = e.title;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
    method: "get"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h2", null, "Search for a course"), Course);
}

Wrapper.propTypes = {
  config: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.object,
  initialResults: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.object,
