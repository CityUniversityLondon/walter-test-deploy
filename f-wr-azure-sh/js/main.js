...
function _playVideo() {
  _playVideo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(video, button) {
...
function handleLoadMoreClick(keyInformation) {
  var hiddenDates = Array.from(keyInformation.querySelectorAll(".".concat(className, "__dates > [data-loadmorevisible=\"false\"]"))),
      loadMoreButton = keyInformation.querySelector(".".concat(className, "__controls__loadmore"));

  if (loadMoreBatch >= hiddenDates.length) {
    loadMoreButton.parentNode.removeChild(loadMoreButton);
    var keyInfoWrapper = document.querySelector('.wrapper--key-information--lifelong-learning'),
...
function launchKeyInformation(keyInformation) {
  ...
  nextButton.addEventListener('click', function () {
    return handleNextPrevClick(keyInformation, 1);
  }, true);
  ...
  keyInformation.addEventListener('keydown', function (e) {
    switch (e.key) {
      case arrowLeft:
        prevButton.click();
        break;
  ...
  if (startDates.length > loadMoreBatch) {
    ...
    loadMoreButton.addEventListener('click', function () {
      return handleLoadMoreClick(keyInformation);
    }, true);
  }
...
/* harmony import */ var _aria_attributes__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../aria-attributes */ "./src/aria-attributes.js");
...
function prepareSlides(slides, current) {
  slides.forEach(function (slide, i) {
    ...
    slide.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].label, "Slide ".concat(i + 1, " of ").concat(slides.length)); // Accesiblity
...
function launchArrow(slider) {
  ...
  if (1 >= slides.length) {
    Object(_util__WEBPACK_IMPORTED_MODULE_17__["removeClass"])(slider, className, false);
    return;
  ...
  dividerVisible.appendChild(document.createTextNode('/'));
  dividerVisible.className = className + '__indicator__divider--visible';
  dividerVisible.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].hidden, 'true');
  dividerScreenReader.appendChild(document.createTextNode(' of '));
  dividerScreenReader.className = className + '__indicator__divider--sr';
  divider.appendChild(dividerVisible);
  divider.appendChild(dividerScreenReader);
  ...
  controlsWrapper.appendChild(nextButton);
  controlsWrapper.className = className + '__controls';
  controlsWrapper.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].label, 'Slider navigation'); // Places controls directly after 'ul' containing the slides
...
function launchDot(slider) {
  ...
  slides.forEach(function (slide, i) {
    ...
    var dot = Object(_util__WEBPACK_IMPORTED_MODULE_17__["createHTMLElement"])('button', [{
      label: 'data-page',
      val: i
    }, {
      label: 'aria-label',
    ...
    if (i === 0) {
      // Active slide
      dot.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].current, 'slide');
      dot.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].expanded, 'true');
      dot.setAttribute('disabled', 'true');
    } else {
      // All other slides
      dot.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_18__["default"].expanded, 'false');
    }
...
function launchImageCredit(picture) {
  var display = Object(_util__WEBPACK_IMPORTED_MODULE_1__["toBool"])(picture.dataset.tooltipdisplay),
...
module.exports = __webpack_require__(/*! /opt/azagent/_work/2/s/src/main.js */"./src/main.js");
