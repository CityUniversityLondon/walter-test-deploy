...
function Wrapper(props) {
  const Course = props.initialResults && props.initialResults.results && props.initialResults.results.map((e, i) => {
    let code = e.listMetadata.code && e.listMetadata.code[0],
        title = e.title;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
    method: "get"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Search for a course"), Course);
}
...
module.exports = __webpack_require__(/*! /home/rof/src/github.com/CityUniversityLondon/walter-test/src/matrix-server/test-ssr.js */"./src/matrix-server/test-ssr.js");
